    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-[#070710]">
      ...
      <div className="login-card w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">Sign in to your AI Employee account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="login-email" className="block text-xs text-gray-400 mb-1.5 font-medium">Email</label>
            <input
              id="login-email"
              type="email"
              value={email}
          ...
          <div>
            <label htmlFor="login-password" className="block text-xs text-gray-400 mb-1.5 font-medium">Password</label>
            <input
              id="login-password"
              type="password"
              value={password}
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full py-3 bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 disabled:opacity-50 rounded-xl font-semibold text-sm transition-all shadow-lg shadow-violet-600/20 hover:scale-[1.01]"
          >
